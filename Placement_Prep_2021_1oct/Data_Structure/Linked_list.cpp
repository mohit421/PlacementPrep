...
//                                           GFG 
//  Print Linked List elements in c++
/*
#include<iostream>
#include<cstdio>
#include<cstdlib>
...
// Use corner cases then got ouput as expected
/*
...
int main(){
    ...
    insertAtTail(head,5);
    display(head);
    // deletion(head,4);    //all node deleted
    deleteAtHead(head);
    display(head);
    return 0;
}
...
// Doubly Linked List 
// Implemention Insertion in Doubly linked list
